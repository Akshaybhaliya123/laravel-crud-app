             ...
             <div class="card border-0 shadow-lg my-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3" >
                        ...
                        <input type="text" value="{{old('sku',$product->sku)}}" class="@error('name') is-invalid @enderror form-control form-control-lg" placeholder="Sku" name="sku">
                        @error('sku')
                        <p class="invalid-feedback">{{$message}}</p>
                        @enderror
                    </div>
                    <div class="mb-3" >
                        ...
                        <input type="text" value="{{old('price',$product->price)}}" class="@error('name') is-invalid @enderror form-control form-control-lg" placeholder="Price" name="price">
                        @error('price')
                        <p class="invalid-feedback">{{$message}}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3" >
                        ...
                        @if($product->image != "")
                         <img class="my-3" width="180px" src="{{asset('uploads/products/'.$product->image)}}">
                         @endif
                    </div>
                    <div class="d-grid">
